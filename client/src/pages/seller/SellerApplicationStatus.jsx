...
function SellerApplicationStatus() {
        ...
        <div className="mx-auto max-w-2xl rounded-3xl border border-red-200 bg-white p-8 text-center shadow-sm">
          ...
          <div className="mt-6 flex flex-col justify-center gap-3 sm:flex-row">
            <button
              ...
              className="inline-flex rounded-xl border border-gray-300 px-5 py-3 text-sm font-semibold text-gray-900 hover:bg-gray-50"
            >
              Try Again
            </button>
  ...
  // STORE
  //
  // The controller creates/links the store when application
  // is approved. Therefore seller?.store may be null while
        ...
        <div className="rounded-3xl border border-gray-200 bg-white p-6 shadow-sm sm:p-10">
          ...
          {status === 'approved' && (
            <div className="mt-8 grid gap-3 sm:grid-cols-3">
              ...
              <Link
                to="/seller/store"
                className="rounded-xl border border-gray-300 px-5 py-3 text-center text-sm font-semibold text-gray-900 hover:bg-gray-50"
              >
                Manage Store
              </Link>
          ...
          {status === 'rejected' && (
            <div className="mt-8">
              ...
              <Link
                to="/seller/apply"
                className="mt-5 inline-flex rounded-xl bg-black px-5 py-3 text-sm font-semibold text-white hover:bg-gray-800"
              >
                Submit New Application
              </Link>
