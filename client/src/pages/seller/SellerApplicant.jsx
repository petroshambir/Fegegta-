              ...
              <div className="mt-5 grid gap-5 md:grid-cols-2">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="clothing">
                      {translateCategory('clothing')}
                    </option>

                    <option value="accessories">
                      {translateCategory('accessories')}
                    </option>

                    <option value="beauty">
                      {translateCategory('beauty')}
                    </option>

                    <option value="home">
                      {translateCategory('home')}
                    </option>
