...
//       /*
//        * IMPORTANT:
//        * Never put raw card information into the order object.
//        */
...
//        * Test checkout only.
//        *
//        * Real production payment should use
//        * Stripe Checkout / Stripe Elements
//        * or another PCI-compliant provider.
//        */
...
function Checkout() {
  ...
  /* ============================================================
     ...
     - Save complete order.
     - Create one admin notification.
     - Never save raw card information.
  ============================================================ */
  ...
  const handlePlaceOrder = async (event) => {
    ...
    try {
       ...
       *
       * IMPORTANT:
       * sizeData is copied into every order item.
       *
       * This includes:
       *
       * Women:
      ...
      /* ========================================================
         ...
         IMPORTANT:
         The COMPLETE orderData is stored inside
         notification.order.
         
         Therefore AdminNotifications.jsx can read:
         
         notification.order.customer
         notification.order.items
         notification.order.items[].sizeData
         notification.order.subtotal
         notification.order.shipping
       ...
       *
       * The same order must not create
      ...
      if (!notificationAlreadyExists) {
        const notification = {
           ...
           *
           * It contains the customer's selected
