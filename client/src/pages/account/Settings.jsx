  ...
  useEffect(() => {
    const loadSettings = async () => {
      ...
      try {
        ...
        if (
          data.user &&
          typeof data.user.notificationsEnabled ===
            'boolean'
        ) {
          setNotifications(
        ...
        >
          ...
          <div className="flex justify-end">
            ...
            <button
              type="submit"
              disabled={isSaving}
              className="inline-flex items-center gap-2 rounded-lg bg-gray-900 px-5 py-3 text-sm font-semibold text-white hover:bg-gray-800 disabled:cursor-not-allowed disabled:opacity-60"
            >
              <Save size={17} />
